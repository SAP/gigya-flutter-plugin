...
/// The static interop class for the field changed event of the `Account.showScreenset` event stream.
///
...
/// for the [FieldChangedEvent] class.
extension FieldChangedEventExtension on FieldChangedEvent {
