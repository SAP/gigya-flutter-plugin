...
import 'web_screenset_delegate.dart';
...
class GigyaFlutterPluginWeb extends GigyaFlutterPluginPlatform {
  ...
  final WebScreensetDelegate _screensetDelegate = const WebScreensetDelegate();
  ...
  Stream<ScreensetEvent> showScreenSet(
    ...
    return _screensetDelegate.showScreenSet(name, parameters: parameters);
  }
}
